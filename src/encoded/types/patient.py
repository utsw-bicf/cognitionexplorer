...
class Patient(Item):
    ...
    rev = {
        ...
        'ivp_c2v3': ('Ivp_c2v3', 'patient'),
        'ivp_d1v3': ('Ivp_d1v3', 'patient'),
        'ivp_d2v3': ('Ivp_d2v3', 'patient'),
        'ivp_z1xv3': ('Ivp_z1xv3', 'patient'),
        ...
        # 'ivp_c2v2': ('Ivp_c2v2', 'patient'),
        # 'ivp_d1v2': ('Ivp_d1v2', 'patient'),
        # 'ivp_d2v2': ('Ivp_d2v2', 'patient'),
    ...
    def ivp_c2v3(self, request, ivp_c2v3):
        return paths_filtered_by_status(request, ivp_c2v3)
    @calculated_property(schema={
        "title": "Ivp_d1v3",
        "type": "array",
        "items": {
    ...
    def ivp_d2v3(self, request, ivp_d2v3):
        return paths_filtered_by_status(request, ivp_d2v3)
    @calculated_property(schema={
        "title": "Ivp_z1xv3",
        "type": "array",
        "items": {
    ...
    def ivp_z1xv3(self, request, ivp_z1xv3):
        return paths_filtered_by_status(request, ivp_z1xv3)
    @calculated_property(schema={
        "title": "Fvp_a1v3",
        "type": "array",
        "items": {
    ...
    ##     },
    ## })
    ## def ivp_c2v2(self, request, ivp_c2v2):
    ##     return paths_filtered_by_status(request, ivp_c2v2)
    ## @calculated_property(schema={
    ##     "title": "Ivp_d1v2",
    ##     "type": "array",
    ##     "items": {
    ...
    ##     },
    ## })
    ## def ivp_d2v2(self, request, ivp_d2v2):
    ##     return paths_filtered_by_status(request, ivp_d2v2)
    ## @calculated_property(schema={
    ##     "title": "Ivp_e1v2",
    ##     "type": "array",
    ##     "items": {
