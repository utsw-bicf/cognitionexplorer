...
class FormsTable extends React.Component {
    ...
    transformData(data) {
        ...
        for (let i = 0; i < data.fvp_c2v3.length; i++) {
            ...
            console.log(index)
            forms[index].c2_id = data.fvp_c2v3[i]['@id']
