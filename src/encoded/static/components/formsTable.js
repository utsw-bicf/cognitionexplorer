...
class FormsTable extends React.Component {
  ...
  transformData(data) {
    ...
    // =================================follow-up visits local version====================================
    // for (let i = 0; i < data.concussion_history_follow_up.length; i++) {
    //   let index =
    //     followUpVisitTimes.indexOf(
    //       data.concussion_history_follow_up[i]["visdate"]
    //     ) + 1;
    //   console.log(index);
    //   forms[index].concussion_history_follow_up_id =
    //     data.concussion_history_follow_up[i]["@id"];
    //   forms[index].concussion_history_follow_up_name =
  ...
  getFollowUpVisitTimes(data) {
    ...
    // ===============================follow-up visits version 3=====================================
    data.fvp_a1v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    data.fvp_a2v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    ...
    data.fvp_b4v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    data.fvp_b5v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    data.fvp_b6v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    data.fvp_b7v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    data.fvp_b8v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    data.fvp_b9v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    data.fvp_c1v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_c2v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    data.fvp_d1v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_d2v3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    data.fvp_z1xv3.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    // ===============================follow-up visits version 2=====================================
    data.fvp_a1v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    ...
    data.fvp_b1v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b2v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b3v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b4v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b5v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b6v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b7v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b8v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b9v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_c1v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_d1v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_e1v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_z1v2.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );

    // ===============================follow-up visits version 1=====================================
    data.fvp_a1v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    ...
    data.fvp_b1v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b2v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b3v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b4v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b5v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b6v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b7v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b8v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_b9v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_c1v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_d1v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_e1v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    data.fvp_z1v1.forEach((element) =>
      followUpVisitTimes.push(element["visdate"])
    );
    // =============================telephone follow-up visits==========================
    // data.tvp_a1.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );
    // data.tvp_a2.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );
    // data.tvp_a3.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );
    // data.tvp_b5.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );
    ...
    //   followUpVisitTimes.push(element["visdate"])
    // );
    // data.tvp_z1x.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );
    // data.tvp_d2.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );
    // data.tvp_t1.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );
    // data.tvp_b4.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );
    // data.tvp_b7.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );

    // data.tvp_a4.forEach((element) =>
    //   followUpVisitTimes.push(element["visdate"])
    // );
    // ===========================follow-up visits local forms==============================
  //   data.concussion_history_follow_up.forEach((element) =>
  //     followUpVisitTimes.push(element["visdate"])
  //   );
  ...
  renderData() {
    const tableColumns = {
      ...
      a1_id: {
        ...
        display: (form) => (
          <div>
            {form.a1v3_id && (
              <span>
                <a href={form.a1v3_id}>{form.a1v3_name}</a>{" "}
              </span>
            )}

            {form.a2v3_id && (
              <span>
                <a href={form.a2v3_id}>{form.a2v3_name}</a>{" "}
              </span>
            )}
      ...
      b1_id: {
        ...
        display: (form) => (
          <div>
            {form.b1v3_id && (
              <span>
                <a href={form.b1v3_id}>{form.b1v3_name}</a>{" "}
              </span>
            )}
            {form.b1v3_id && (
              <span>
            ...
            {form.b4v3_id && (
              <span>
                <a href={form.b4v3_id}>{form.b4v3_name}</a>{" "}
              </span>
            )}

            {form.b5v3_id && (
              <span>
                <a href={form.b5v3_id}>{form.b5v3_name}</a>{" "}
              </span>
            )}

            {form.b6v3_id && (
              <span>
                <a href={form.b6v3_id}>{form.b6v3_name}</a>{" "}
              </span>
            )}
            {form.b7v3_id && (
              <span>
                <a href={form.b7v3_id}>{form.b7v3_name}</a>{" "}
              </span>
            )}
            {form.b8v3_id && (
              <span>
                <a href={form.b8v3_id}>{form.b8v3_name}</a>{" "}
              </span>
            )}
            {form.b9v3_id && (
              <span>
                <a href={form.b9v3_id}>{form.b9v3_name}</a>{" "}
              </span>
            )}
      ...
      c2_id: {
        ...
        display: (form) => (
          <div>
            ...
            {form.c2v3_id && (
              <span>
                <a href={form.c2v3_id}>{form.c2v3_name}</a>{" "}
              </span>
            )}
      ...
      d1_id: {
        ...
        display: (form) => (
          <div>
            ...
            {form.d2v3_id && (
              <span>
                <a href={form.d2v3_id}>{form.d2v3_name}</a>{" "}
              </span>
            )}
      ...
      // t1_id: {
      //   title: "Form T1",
      //   display: (form) => <div>{<a href={form.t1_id}>{form.t1_name}</a>}</div>,
      // },
      // m1_id: {
      //   title: "Form M1",
      ...
      //       {form.moca_id && (
      //         <span>
      //           <a href={form.moca_id}>{form.moca_name}</a>{" "}
      //         </span>
      //       )}
      //       {form.updrs_id && (
      //         <span>
      //           <a href={form.updrs_id}>{form.updrs_name}</a>{" "}
      //         </span>
      //       )}
      //       {form.concussion_history_id && (
      //         <span>
      //           <a href={form.concussion_history_id}>
      //             {form.concussion_history_name}
      //           </a>{" "}
      //         </span>
      //       )}
      //       {form.concussion_history_follow_up_id && (
      //         <span>
      //           <a href={form.concussion_history_follow_up_id}>
      //             {form.concussion_history_follow_up_name}
      //           </a>{" "}
      //         </span>
      //       )}
      //       {form.visit_contact_id && (
      //         <span>
      //           <a href={form.visit_contact_id}>{form.visit_contact_name}</a>{" "}
      //         </span>
      //       )}
      //       {form.physical_exam_id && (
      //         <span>
      //           <a href={form.physical_exam_id}>{form.physical_exam_name}</a>{" "}
      //         </span>
      //       )}
      //     </div>
      //   ),
